...
float facteur_tension[5] = {1.13, 0.997, 1.14, 1.12, 1.1};
float constante_tension[5] = {-0.00806, -0.00111, -0.00847, -0.00771, -0.00736};
float facteur_courant[5] = {-0.00461, 0.0503, -0.00139, -0.0045, -0.00163};
